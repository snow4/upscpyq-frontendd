...
exports.STOREKEY = '__NEXT_REDUX_WRAPPER_STORE__';
...
var getStoreKey = function (_a) {
    ...
    return storeKey || exports.STOREKEY;
};
...
exports.createWrapper = function (makeStore, config) {
    ...
    var getServerSideProps = function (callback) { return getStaticProps(callback); }; // just not to repeat myself
    var withRedux = function (Component) {
        ...
        var Wrapper = function (_a, context) {
            ...
            var store = react_1.useRef(initStore({ makeStore: makeStore, config: config, context: context }));
            var hydrate = react_1.useCallback(function () {
            ...
            return (react_1.default.createElement(react_redux_1.Provider, { store: store.current },
                react_1.default.createElement(Component, __assign({}, initialProps, props))));
        };
